...
import 'package:ayu_doctor/screens/verify_screen.dart';
import 'package:ayu_doctor/utils/colors.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:pinput/pinput.dart';

class SignInOtpVerification extends StatefulWidget {
  final String phone;
  const SignInOtpVerification({Key? key, required this.phone})
      : super(key: key);

  @override
  State<SignInOtpVerification> createState() => _SignInOtpVerificationState();
}

class _SignInOtpVerificationState extends State<SignInOtpVerification> {
  ...
  Future checkIfUserIsVerified(String uid) async {
    Doctor data = await getDoctor();
    if (data.isVerified) {
  ...
  Future moveToNextScreen(String pin) async {
    try {
      await FirebaseAuth.instance
          ...
          .then((value) async {
        if (value.user != null) {
          checkIfUserIsVerified(value.user!.uid);
        }
      });
